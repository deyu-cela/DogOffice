...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  { id: 'policy', name: '流程優化手冊', cost: 54, desc: '改善穩定度，減少亂流。', statTags: [{ label: '穩定+1', type: 'up' }] },
  ...
  { id: 'artwall', name: '品牌展示牆', cost: 88, desc: '讓辦公室更有風格，也能帶來話題。', statTags: [{ label: '裝飾+2', type: 'up' }, { label: '士氣+4', type: 'up' }, { label: '產能+1', type: 'up' }] },
  { id: 'coffee', name: '精品咖啡機', cost: 56, desc: '提神醒腦！產能與士氣都微幅提升。', statTags: [{ label: '產能+1', type: 'up' }, { label: '士氣+5', type: 'up' }] },
  { id: 'gym', name: '狗狗健身區', cost: 95, desc: '強身健體，穩定度大幅提升。', statTags: [{ label: '穩定+2', type: 'up' }, { label: '士氣+6', type: 'up' }, { label: '營運+3', type: 'up' }] },
];
